...
for (var i = 0; i <= 9; i++) {      /**Note- standard for loop counting 0 to 9*/
    console.log(i)
}
{/*Answer:
...
for (var i = 9; i >= 0; i--) {      /**Note- standard for loop counting 9 to 0*/
    console.log(i)
}
{/*Answer:
[Running] node "/home/chance/lvl1Vschool/lvl1assignments/10. Loop Olympics Story Point 49/tempCodeRunnerFile.js"
...
for (var i = 0; i < fruit.length; i++) {        /**Note- for loop which will return each item in an array. ".lenght" counts full index of array*/
    console.log(fruit[i])                       /**Note- must include "array name" with index variable or number to return item*/
}
{/*Answer:
[Running] node "/home/chance/lvl1Vschool/lvl1assignments/10. Loop Olympics Story Point 49/tempCodeRunnerFile.js"
banana
...
{/*NOTE FROM "NESTED LOOPS STORY POINT 47"
*****************************************************************            
var arrayOfArrays = [
    [1, 2, 3],
    [4, 5, 6],
